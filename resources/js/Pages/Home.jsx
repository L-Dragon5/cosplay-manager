            ...
            <SimpleGrid columns={3} spacing={5}>
              <Flex flexDirection="column">
                ...
                <Text textAlign="center" mb={6}>
                  Organize your cosplay plans and ones currently owned in one
                  easy place. Easy to look through and organize with images and
              ...
              <Flex flexDirection="column">
                ...
                <Text textAlign="center">
                  ...
                  right tool for you. Just paste in the taobao link of your
                  choice and it will grab the necessary information of the item
                  and display in it a grid format for easy viewing and access.
                </Text>
              </Flex>
              <Flex flexDirection="column">
                <Heading as="h2" size="xl" textAlign="center" mb={3}>
        ...
        >
          <Container maxW="150ch" centerContent>
            ...
            <Text textAlign="center" mb={5}>
              ...
              ). My girlfriend and a lot of my friends are very active
              cosplayers, so I built this website as a collection of tools for
              them to use to organize their plans.
            </Text>
            <Text textAlign="center" mb={10}>
              Feel free to contact me if you have any problems or any things you
              wanted added in the future. I hope to grow this as much as
              possible!
            </Text>
            <Button
              as={Link}
