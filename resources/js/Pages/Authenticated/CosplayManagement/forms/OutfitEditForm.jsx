...
function OutfitEditForm({ outfit, tags, series, onClose }) {
  ...
  const [seriesChoice, setSeriesChoice] = useState(
    series.find((s) => s.characters.find((c) => c.id === outfit.character_id))
      ?.id ?? '',
  );
      ...
      <HStack width="full">
        <FormControl id="outfit-series" isRequired>
          ...
          <Select
            ...
            onChange={(e) => setSeriesChoice(Number(e.target.value))}
            value={seriesChoice}
          >
            {series.map((item) => (
        ...
        <FormControl id="outfit-character" isRequired>
          ...
          <Select
            ...
            onChange={(e) => setData('character_id', Number(e.target.value))}
            defaultValue={outfit.character_id}
            isDisabled={seriesChoice === ''}
          >
            {series
              ?.find((item) => item.id === seriesChoice)
