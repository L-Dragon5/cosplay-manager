...
class OutfitCard extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      allTags:
        props.allTags !== undefined && props.allTags !== null
          ? props.allTags
          : [],
    };
  ...
  handleDelete(e) {
    ...
    if (
      confirm(
        `Are you sure you want to delete this outfit [${this.state.title}]? This action is not reversible.`,
      )
    ) {
      ...
      if (answer === 'DELETE') {
        axios
          .get(`/api/outfit/destroy/${this.id}`, {
            headers: {
  ...
  handleRemovePhoto(e, index) {
    ...
    axios
      .get(`/api/outfit/${this.id}/deleteImage/${index}`, {
        headers: {
          Accept: 'application/json',
          Authorization: `Bearer ${this.token}`,
          'content-type': 'multipart/form-data',
          ...
          <>
            <div className={`outfit ${statusClass} card medium`}>
                    ...
                    return (
                      <a key={i} className="carousel-item" href={url}>
                        ...
                        <div
                          ...
                          onClick={(e) => this.handleRemovePhoto(e, i)}
                        >
              ...
              <div className="card-action">
                ...
                >
                  <a className="btn-flat teal lighten-2">
              ...
              <div className="card-reveal">
                ...
                <ul>
                  <li>
                    <strong>Obtained On:</strong> {obtainedOn}
                  </li>
                  <li>
                    <strong>Creator:</strong> {this.state.creator}
                  </li>
                  <li>
                    <strong>Storage Location:</strong>{' '}
                    {this.state.storage_location}
                  </li>
                  <li>
                    <strong>Times Worn:</strong> {this.state.times_worn}
                  </li>
                </ul>
              </div>
            </div>
